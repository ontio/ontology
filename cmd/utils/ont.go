...
func Transfer(gasPrice, gasLimit uint64, signer *account.Account, from, to string, amount uint64) (string, error) {
	transferTx, err := TransferTx(gasPrice, gasLimit, "ont", signer.Address.ToBase58(), to, amount)
	if err != nil {
		return "", err
	}
