...
func TestParseNativeParam(t *testing.T) {
	paramAbi := []*abi.NativeContractParamAbi{
		...
		{Name: "Param6", Type: "Byte"},
		{Name: "Param7", Type: "ByteArray"},
		{Name: "Param8", Type: "Array", SubType: []*abi.NativeContractParamAbi{
			{Name: "", Type: "Int"},
		},
		},
		{Name: "Param9", Type: "Struct", SubType: []*abi.NativeContractParamAbi{
			{Name: "Param9_0", Type: "String"},
			{Name: "Param9_1", Type: "Int"},
		},
		},
	}
