...
func PreExecuteContract(tx *types.Transaction) (*store.PreExecResult, error) {
	return ledger.DefLedger.PreExecuteContract(tx)
}

func PreExecuteContractBatch(tx []*types.Transaction, atomic bool) ([]*store.PreExecResult, uint32, error) {
