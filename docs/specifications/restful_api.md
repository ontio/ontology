...
| [get_shard_smtcode_evts](#12-get_shard_smtcode_evts) | GET /api/v1/shard/smartcode/event/txhash/:sourcetxhash | The event of the shard transaction invoked by the source transaction hash is obtained. |
| [get_shard_tx_state](#25-get_shard_tx_state) | GET /api/v1/shardtxstate/:txhash/:notifyid | query txstate through txhash and notifyid |
...
The event of the shard transaction invoked by the source transaction hash is obtained.
...
#### Request Example:
```
curl -i http://localhost:20334/api/v1/shard/smartcode/event/txhash/cb93074c6e9ca615cc1c6139f3bfdb348184024c4ae827a05bbbbd198eb931a6
```
#### Response:
```
{
    "Action": "getshardsmartcodeevent",
    "Desc": "SUCCESS",
    "Error": 0,
    "Result": {
        "TxHash": "44d6e78025cecbb9cc493850f8b8d016de76e76c2a82d1225b65f8c37c57f510",
        "State": 0,
        "GasConsumed": 0,
        "Notify": [
            {
                ...
                "SourceTxHash": "cb93074c6e9ca615cc1c6139f3bfdb348184024c4ae827a05bbbbd198eb931a6"
            }
        ]
    },
    "Version": "1.0.0"
...
### 25 get_shard_tx_state

Query txstate through txhash and notifyid

GET
```
/api/v1/shardtxstate/:txhash/:notifyid
```

notifyid is not necessary

#### Request Example:
```
curl -i http://127.0.0.1:30334/api/v1/shardtxstate/fb64410d900a237ee63502af33f68944ef01006330213fdca8d29d1e7d06c44e
```
#### Response:
```
{
    "Action": "getshardtxstate",
    "Desc": "SUCCESS",
    "Error": 0,
    "Result": {
