...
const (
	...
	EMERGENCY_REQ_TYPE = "emgreq"     // emergency governance request
	EMERGENCY_RSP_TYPE = "emgrsp"     // emergency governance responses
)
...
const (
	EmergencyAdminStart EmergencyType = iota
	EmergencyReq
	EmergencyRsp
)

type EmergencyMsg struct {
	MsgType EmergencyType
	Content interface{}
}
