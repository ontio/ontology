...
//ping msg package
func NewPingMsg(heights map[common.ShardID]*mt.HeightInfo) *mt.Ping {
	log.Trace()
	var ping mt.Ping
	ping.Height = heights
...
//pong msg package
func NewPongMsg(heights map[common.ShardID]*mt.HeightInfo) *mt.Pong {
	log.Trace()
	var pong mt.Pong
	pong.Height = heights
...
//Version package
func NewVersion(n p2pnet.P2P, heights map[common.ShardID]*mt.HeightInfo) mt.Message {
	log.Trace()
