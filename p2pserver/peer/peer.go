...
type PeerCom struct {
	...
	httpInfoPort uint16
	port         uint16
	height       map[comm.ShardID]*types.HeightInfo
	softVersion  string
...
func (this *PeerCom) SetHeight(height map[comm.ShardID]*types.HeightInfo) {
	if len(height) > 0 {
		this.height = height
	}
}
...
func (this *PeerCom) GetHeight() map[comm.ShardID]*types.HeightInfo {
	return this.height
}
...
func (this *Peer) GetHeight() map[comm.ShardID]*types.HeightInfo {
	return this.base.GetHeight()
}

//SetHeight set height to peer
func (this *Peer) SetHeight(height map[comm.ShardID]*types.HeightInfo) {
...
func (this *Peer) UpdateInfo(t time.Time, version uint32, services uint64,
	syncPort uint16, nonce uint64, relay uint8, height map[comm.ShardID]*types.HeightInfo, softVer string) {
