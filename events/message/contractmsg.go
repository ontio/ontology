...
type ContractLifetimeEvent struct {
	Version       uint32
	DeployHeight  uint32
...
func (this *ContractLifetimeEvent) Serialization(sink *common.ZeroCopySink) {
...
func (this *ContractLifetimeEvent) Deserialization(source *common.ZeroCopySource) error {
	var eof bool
