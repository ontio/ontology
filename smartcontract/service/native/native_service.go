...
func (this *NativeService) NeoVMCall(address common.Address, method string, args []byte,
	...
	stacks[1] = ntypes.NewArray([]ntypes.StackItems{ntypes.NewByteArray(args),
		ntypes.NewByteArray(fromContractAddress), ntypes.NewInteger(new(big.Int).SetUint64(fromChainID))})
