...
var (
	...
	ETHLayer2ContractAddress, _  = common.AddressParseFromBytes([]byte{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0c})
	//WARN: when add Contract Here, please update IsNativeContract function bellow.
)

func IsNativeContract(addr common.Address) bool {
	switch addr {
	case OntContractAddress,
		OngContractAddress,
