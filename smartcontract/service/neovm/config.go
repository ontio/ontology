...
var (
	...
	CONTRACT_SET_META_DATA_GAS    uint64 = 2000000
	...
	CONTRACT_SET_META_DATA_NAME     = "Ontology.Contract.InitMetaData"
	...
	INIT_GAS_TABLE = map[string]uint64{
		...
		CONTRACT_SET_META_DATA_NAME:    CONTRACT_SET_META_DATA_GAS,
