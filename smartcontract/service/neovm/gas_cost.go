...
func StoreGasCost(gasTable map[string]uint64, engine *vm.ExecutionEngine) (uint64, error) {
...
func GasPrice(gasTable map[string]uint64, engine *vm.ExecutionEngine, name string) (uint64, error) {
	switch name {
