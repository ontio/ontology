...
var (
	...
	ServiceMap = map[string]Service{
		...
		"Neo.Blockchain.GetContract": {Execute: BlockChainGetContract},
		...
		"Neo.Header.GetPrevHash": {Execute: HeaderGetPrevHash},
		...
		"Neo.Header.GetMerkleRoot": {Execute: HeaderGetMerkleRoot},
		...
		"Neo.Contract.GetScript": {Execute: ContractGetCode},
