...
func (self *Ledger) GetShardTxState(txHash common.Uint256, notifyId uint32, hasNotifyId bool) (*xshard_state.TxState, error) {
	return self.ldgStore.GetShardTxState(txHash, notifyId, hasNotifyId)
}
